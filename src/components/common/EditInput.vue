  ...
  <div class="py-4 bg-gray-50 px-6">
    <div class="max-w-md">
      ...
      <input
        ...
        v-model="inputValue"
        :type="inputType"
        class="bg-white border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition-colors duration-200 hover:border-gray-400 focus:outline-none"
