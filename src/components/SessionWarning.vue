...
<template>
  ...
  >
    <div class="bg-white rounded-lg p-8 max-w-md text-center shadow-2xl">
      ...
      <button
        @click="closeSession"
        class="w-full mt-2 bg-gray-300 text-gray-800 py-3 rounded-lg font-semibold hover:bg-gray-400 transition"
      >
        Cerrar sesión
      </button>
    </div>
...
const { showWarning, timeRemaining, continueSession, closeSession } =
  useSessionTimeout();
</script>
